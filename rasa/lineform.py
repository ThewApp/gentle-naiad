...
class LineForm(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        """Execute the side effects of this form:
            ...
            - set validated slots
            - line_ask_{slot} template with the next required slot
        ...
        for e in events:
            if isinstance(e, SlotSet):
                temp_tracker.slots[getattr(e, "key")].value = getattr(e, "value")
